...
#    plot_solution(X_star, p_star - p_pred, 5)
    ...
    print("\n[Noiseless Data]")
    print("Error u        : %.6e" % error_u)
    print("Error v        : %.6e" % error_v)
    print("Error p        : %.6e" % error_p)
    print("Error lambda_1 : %.6f%%" % error_lambda_1)
    print("Error lambda_2 : %.6f%%" % error_lambda_2)
    print("Lambda_1       : %.6f" % lambda_1_value)
    print("Lambda_2       : %.8f" % lambda_2_value)

    print("\n[Noisy Data : noise = %.2f]" % noise)
    print("Error lambda_1 : %.6f%%" % error_lambda_1_noisy)
    print("Error lambda_2 : %.6f%%" % error_lambda_2_noisy)
    print("Lambda_1       : %.6f" % lambda_1_value_noisy)
    print("Lambda_2       : %.8f" % lambda_2_value_noisy)
